...
The current implementation exposes lap in snapshots and the timing UI. It does not yet implement race finish, classification finalization, pit stops, penalties, or championship scoring.
